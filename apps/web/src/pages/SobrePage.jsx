      ...
      <main className="pt-32">
        ...
        <section className="py-20 px-6 bg-section-contrast border-y border-border">
          <div className="max-w-5xl mx-auto">
            ...
            delay: 0.2
          }} className="text-xl md:text-2xl font-light leading-relaxed text-foreground/90">
              <p>
              ...
              <blockquote className="border-l-4 border-primary pl-6 py-3 mt-8 text-lg md:text-xl italic text-muted-foreground bg-primary/5 rounded-r-lg">
